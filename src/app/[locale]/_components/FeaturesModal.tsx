    ...
    return (
        <>
            <button onClick={openModal}
                    className={'bg-white hover:bg-gray-100 transition-all px-8 py-3 border border-black font-light uppercase w-fit text-sm'}>
                {t('btn-text-3')}
            </button>
            {isOpen && (
                <div
                ...
                >
                    ...
                    >
                        ...
                        <h2 className="text-3xl">Everything for Your Perfect Vacation</h2>
                        <div className={'my-10'}>
                            <h1>Here goes features from booking</h1>
                        </div>
