...
export default function Second() {
    ...
    return(
        <section id={'attractions'} className={'px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-28 w-screen my-20 flex flex-col gap-20'}>
            <div
                ...
                <div
                    ...
                    <FilledLink href={`/${localActive}#reservation`}>{t('btn-text-1')}</FilledLink>
                </div>
            </div>
            <div
