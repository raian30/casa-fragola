            ...
            <div className="bg-[#F5F5F5] px-10 md:px-20 lg:px-12 xl:px-[5.5rem] 2xl:px-[7.5rem] py-20 flex flex-col gap-20">
                <div className={'flex flex-col gap-10'}>
                    <h2 className={'text-xl md:text-[1.2rem] font-light'}>Do you want to enjoy your holiday in peace and
                        sepration from the rest of the world, and yet be close to events and entertainment and
                        gastronomic
                ...
                <div className={'flex flex-col gap-10'}>
                    ...
                    <h2 className={'text-xl md:text-[1.2rem] font-light sm:w-2/3 lg:w-1/2'}>Do you want to enjoy your
                        holiday in peace
                        and
                        sepration from the rest of the world, and yet be close to events and entertainment and
                        gastronomic
