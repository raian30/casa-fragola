...
export default function Hero() {
    return (
        <>
            <div className={'bg-[#F5F5F5] relative px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-28 h-[calc(100dvh-120px)] w-screen'}>
            ...
            <div className={'bg-[#F5F5F5] w-screen px-12 md:px-20 lg:px-24 xl:px-44 2xl:px-60 py-20'}>
                <h2 className={'text-[1.4rem] font-light'}>Želite li miran i opušten odmor
