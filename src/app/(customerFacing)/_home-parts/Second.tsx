...
export default function Second() {
    return(
        <section className={'px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-28 w-screen my-20 flex flex-col gap-20'}>
            <div
                className={'bg-[#EAD7E6] gap-16 lg:gap-0 flex flex-col lg:flex-row items-center justify-center lg:justify-between px-8 lg:px-0 pt-12 md:pt-16 2xl:pt-28 pb-12 md:pb-16 2xl:pb-28 lg:pl-12 xl:pl-20 2xl:pl-28'}>
            ...
            <div
                className={'bg-[#EDE8B8] gap-16 lg:gap-0 flex flex-col lg:flex-row items-center justify-center lg:justify-between px-8 lg:px-0 pt-12 md:pt-16 2xl:pt-28 pb-12 md:pb-16 2xl:pb-28 lg:pr-12 xl:pr-20 2xl:pr-28'}>
                <div
                    className={'w-full lg:w-1/2 text-center px-5 lg:px-10 xl:px-20 2xl:px-52 flex flex-col items-center justify-center gap-10'}>
            ...
            <div
                className={'gap-32 xl:gap-40 flex flex-col lg:flex-row items-center justify-between px-8 lg:px-0 pt-12 md:pt-16 2xl:pt-28 pb-12 md:pb-16 2xl:pb-28'}>
                <div
                    ...
                    <p className={'text-lg font-light'}>Do you want to enjoy your holiday in peace and sepration from
                        the rest of the world, and yet be close to events and entertainment and gastronomic and
                        oenological hedonism</p>
                    <FilledLink href={'/'} className={'uppercase'}>Pogledajte sve značajke</FilledLink>
                </div>
                <div className={'w-full h-full lg:w-1/2 grid grid-cols-2 gap-2'}>
                    <div className={'flex gap-2'}><Bed/> <p>3 beds (1 double and 2 single)</p></div>
                    <div className={'flex gap-2'}><Image src={'/pool.svg'} width={23} height={23} alt={'pool'}/> <p>Outdoor swimming pool</p></div>
